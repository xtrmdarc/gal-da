...
@section('content')
    ...
    <div class="background-light-brand" style="height:100%">
        <div class="background-light-brand">
            ...
            <div class="row section_landing">
                <div class=" col-sm-12 "   >
                    <h2 class=" light-shade-color text-center center-block" style="font-weight:700;width:50%;">Tu cuenta ya ha sido verificada anteriormente!</h2>
                </div>
                <div class=" col-sm-12 section_landing "   >
                    <a href="/login"><h2 class="brand-color text-center center-block" style="font-weight:700;width:50%;">Inicia sesi&oacute;n</h2></a>
                </div>
