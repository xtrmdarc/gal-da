    ...
    var i = function() {
        ...
        $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
            $("body").hasClass("mini-sidebar") ? ($("body").trigger("resize"), $(".scroll-sidebar, .slimScrollDiv").css("overflow", "hidden").parent().css("overflow", "visible"),
                $("body").removeClass("mini-sidebar"), $(".navbar-brand span").show(),$('.navbar-header').css('display','block')) : ($("body").trigger("resize"),
                $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"),
                $("body").addClass("mini-sidebar"), $(".navbar-brand span").hide(),$('.navbar-header').css('display','none') );
        }),



        $(".fix-header .header").stick_in_parent({}), $(".nav-toggler").click(function() {
            $("body").toggleClass("show-sidebar"), $(".nav-toggler i").toggleClass("mdi mdi-menu"),0-+
        ...
        $('#slc_sucursal').on('change',function(e){

            $.get('/CambioSucursal/'+this.value,function(data,status){
                console.log('exito');
...
var NonSideBarCssStyles = function (){
    
    $(".page-wrapper").addClass("NonMarginSideBar");    
    console.log('entro');
};
