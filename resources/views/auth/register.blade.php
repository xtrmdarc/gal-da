    ...
    <form
        ...
        <header class="register-form-nav">
            <ol class="register-phases card-center">
                <li class="site-color active">
                    <button type="button" data-index="1">Crear una cuenta</button>
                </li>
                <li class="site-color">
                    <button type="button" data-index="2" disabled>Seleccion un Plan</button>
                </li>
                <li class="site-color">
                    <button type="button" data-index="3" disabled>Metodo de Pago</button>
                </li>
            </ol>
        </header>
