	...
	.DataTable({
        ...
                return '<p class="text-right bold">'+moneda+' '+data+'</p>';
            ...
                    return '<p class="text-center">'
                    +'<a class="btn btn-sm btn-success" onclick="detalle_c('+data.id_compra+')"><i class="fa fa-files-o"></i></a>'
                    +'&nbsp<a class="btn btn-sm btn-info" onclick="detalle('+data.id_compra+')"><i class="fa fa-eye"></i></a>'
                    +'</p>';
                }
            }
		]
