...
namespace App\Http\Controllers\Informes\Compras;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\DB;

class inf_proveedorController extends Controller
{
    //
    public function index()
    {
        ...
        return view('contents.informes.compras.inf_proveedores',$viewdata);
    }
