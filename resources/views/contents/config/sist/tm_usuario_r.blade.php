...
@section('content')
    ...
    <script src="{{URL::to('scripts/config/func_usuario_e.js' )}}"></script>
    <script src="{{URL::to('scripts/js/plugins/wizard/jquery.bootstrap.wizard.js' )}}" type="text/javascript"></script>
    <script src="{{URL::to('scripts/js/plugins/wizard/wizard.js' )}}"></script>
    <script src="{{URL::to('scripts/js/jquery.email-autocomplete.min.js' )}}"></script>
