...
<script src="{{URL::to('scripts/inicio/func-procesos.js')}}"></script>
<script src="{{URL::to('scripts/inicio/func-cliente.js')}}"></script>
<script src="{{URL::to('js/jquery-ui-1.12.1/jquery-ui.min.js')}}"></script>
<script src="{{URL::to('js/js-render.js')}}"></script>
