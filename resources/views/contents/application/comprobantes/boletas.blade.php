...
<div class="wrapper wrapper-content animated shake">
    <div class="ibox">
        <div class="ibox-title">
            ...
            <h5>Consulta de boletas de venta</h5>
        </div>
        <div class="ibox-content form-modern" style="position: relative; min-height: 30px;">
            {{-- filtros --}}
            <form id="frm-buscar-boletas" action="/buscarBoletas" method="POST">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <table id="table-boleta-comprobante" class="table " style="position:relative" >
                        <thead>
                            <tr>
                                <th>Serie</th>
                                <th>Número</th>
...
@section('scripts')
    ...
    <script src="{{URL::to('rest/scripts/comprobantes/boleta.js')}} "> </script>
@endsection()